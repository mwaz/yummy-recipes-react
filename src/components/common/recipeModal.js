          ...
          <div className="form-group">
            ...
            <div className="col-md-12">
              <input
                ...
                id="recipe_name"
                placeholder={props.recipe_name}
                value={props.recipe_name_value}
            ...
            <div className="col-md-12">
              <textarea
                ...
                placeholder={props.recipe_ingredients}
                value={props.recipe_ingredients_value}
                onChange={props.ingredients_change}
                readonly={props.readonly}
              >
              </textarea>
            </div>
            ...
            <div className="col-md-12">
              <textarea
                ...
                className="form-control"
                id="recipe_methods"
                placeholder={props.recipe_methods}
                value={props.recipe_methods_value}
                onChange={props.recipe_methods_change}
                readonly={props.readonly}
              >
              </textarea>
            </div>
